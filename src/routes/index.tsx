                  ...
                  <div className="space-y-3">
                    <div className="bg-slate-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge variant="outline">{opportunity.bets.home.bookmaker}</Badge>
                      </div>
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div>
                          <div className="text-slate-400">Odds</div>
                          <div className="font-bold text-lg">{opportunity.bets.home.odds}</div>
                        </div>
                        <div>
                          <div className="text-slate-400">Stake</div>
                          <div className="font-bold text-lg">${opportunity.bets.home.stake}</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-slate-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge variant="outline">{opportunity.bets.draw.bookmaker}</Badge>
                      </div>
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div>
                          <div className="text-slate-400">Odds</div>
                          <div className="font-bold text-lg">{opportunity.bets.draw.odds}</div>
                        </div>
                        <div>
                          <div className="text-slate-400">Stake</div>
                          <div className="font-bold text-lg">${opportunity.bets.draw.stake}</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-slate-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge variant="outline">{opportunity.bets.away.bookmaker}</Badge>
                      </div>
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div>
                          <div className="text-slate-400">Odds</div>
                          <div className="font-bold text-lg">{opportunity.bets.away.odds}</div>
                        </div>
                        <div>
                          <div className="text-slate-400">Stake</div>
                          <div className="font-bold text-lg">${opportunity.bets.away.stake}</div>
                        </div>
                      </div>
                    </div>
                  </div>
